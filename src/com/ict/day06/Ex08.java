...
public class Ex08 {
	public static void main(String[] args) {
		...
		// 19. trim() : String
		// 해당 문자열의 앞, 뒤, 공백제거, 중간공백은 제거하지 않는다.
		...
		// toffset => 시작위치
		// endsWith(String suffix) : boolean => 주어진 문자열로 끝나는지검색
		...
		// 22. Wrapper 클래스
		// 기본 자료명의 형태를 가진 문자열을 해당 자료형으로 변경시키는 클래스들
		...
		// 실제 불린 형으로 변경했으므로 덧셈 계산을 할 수 없다.
		// System.out.println(msg2+1);//불가능
		...
		//22-4. 문자열을 double로 변경 : Double.parseDouble();
		msg="3.17598";
		...
		//    그러나 String에 charAt()사용하면 character로 만들 수 있다.
		msg ="A";
